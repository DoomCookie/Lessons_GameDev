...
namespace Lesson02
{
    internal class Bullet : Character
    {
        ...
        public Utils.Guns TypeGun { get; }

        public Bullet(PointF position, SizeF size, float speed, Utils.Characters characterOwner, Utils.Guns typeGun) : base(position, size, speed)
        {
